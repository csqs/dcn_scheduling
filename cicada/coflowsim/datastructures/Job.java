...
import coflowsim.datastructures.Flow;//csqs
...
public class Job implements Comparable<Job> {
  ...
  public double flowFinishedBytes;//csqs
  ...
  //csqs
  public Vector<Task> mapperTask;
  public Vector<Task> reducerTask;
  //public Vector<Task> mrTask;
    
  public Vector<Task> detectActiveMT;
  public Vector<Task> detectTouchedRT;
    
  public Vector<Flow> detectFlows;
  public Vector<Flow> transferFlows;
  public int flowFinished;
  public int comPattern;
  ...
  public Job(String jobName, int jobID) {
    ...
    */
    ...
    mapperTask = new Vector<Task>();
    reducerTask = new Vector<Task>();
    //mrTask = new Vector<Task>();
    detectActiveMT = new Vector<Task>();
    detectTouchedRT = new Vector<Task>();
      
    detectFlows = new Vector<Flow>();
    transferFlows = new Vector<Flow>();
  ...
  public void onTaskFinish(Task task) {
    ...
    numActiveReducers--;
//    if(jobID == 3)
//        System.err.printf("function in onTaskFinish %5d\n", numActiveTasks);
  ...
  public void decreaseShuffleBytesPerRack(int rackID, double decreaseBy) {
    //System.out.printf("Rack:%d Left:%#.4f Shuffle:%#.4f--s.t.--\n", rackID, shuffleBytesPerRack[rackID], decreaseBy);//for schedule trace --- csqs

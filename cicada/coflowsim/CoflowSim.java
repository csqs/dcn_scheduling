...
import coflowsim.simulators.CoflowSimulatorCicada;
...
public class CoflowSim {
  ...
  public static void main(String[] args) {
    ...
    if (args.length > curArg) {
      ...
      } else if (UPPER_ARG.contains("CICADA")) {
          sharingAlgo = SHARING_ALGO.SEBFC;
      } else {
    ...
    } else if (sharingAlgo == SHARING_ALGO.SEBFC) {
        nlpl = new CoflowSimulatorCicada(sharingAlgo, traceProducer, isOffline, considerDeadline,deadlineMultRandomFactor);
    } else {

...
%         group_one = sort(group_one);
        group_one = [1:1:8];
        group_one(1) = 0;
        group_one(2) = randi(5, 1, 1);
        group_one(3) = randi(5, 1, 1) + 5;
        group_one(4) = randi(5, 1, 1) + 10;
        group_one(5) = randi(25, 1, 1) + 50;
        group_one(6) = randi(100, 1, 1) + 250;
        group_one(7) = randi(200, 1, 1) + 1000;
        group_one(8) = randi(500, 1, 1) + 2000;
        group_one = sort(group_one);

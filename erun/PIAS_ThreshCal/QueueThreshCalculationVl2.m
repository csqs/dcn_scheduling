...
function thresh = QueueThreshCalulation()
   ...
   exchange_num = 2;
   mute_range = 2;
   mute_ratio = [10 50 100 300 500 1000 2000];
   stop_ratio = 1e-13;
   stop_genenum = 100;
   new_ratio = 0.95; 
...
%         group_one = sort(group_one);
        ...
        group_one(5) = randi(3000, 1, 1) + 10000;
        group_one(6) = randi(3000, 1, 1) + 12000;
        group_one(7) = randi(5000, 1, 1) + 20000;
        group_one(8) = randi(5000, 1, 1) + 25000;
        group_one = sort(group_one);
